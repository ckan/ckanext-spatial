...
$(function(){
    ...
    $.extend(CKAN.DatasetMap, (function($){
    ...
    //            "pointRadius":7
            ...
            setup: function(){
                ...
                if (this.map_type=='osm') {
                    ...
                    internalProjection = new OpenLayers.Projection("EPSG:4258");
                }
    ...
    OpenLayers.ImgPath = CKAN.DatasetMap.openLayersImagePath;
